...
class OptimizationSettings:
    ...
    pylance_type_checking: str  # 'off', 'basic', 'strict'
        ...
        while True:
            try:
                ...
                if profile.pressure_level != last_pressure_level:
                    print(f"📊 Memory pressure: {profile.pressure_level} ({profile.available_mb:.0f}MB available)")
