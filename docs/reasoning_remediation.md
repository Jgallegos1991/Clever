...
## health_monitor.py (7 incomplete)
...
## tools/generate_reasoning_graph.py (5 incomplete)
...
- module `sync_watcher` (line 1) – missing Why/Where/How
...
## tests/test_mode_variation.py (2 incomplete)
